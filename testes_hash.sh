...
gcc main_query10_parallel.c header.h hash_table.c murmurhash3.c hash_join.c fnv1a.c -O3 -o query10parallel -lm
gcc main_query11.c header.h hash_table.c murmurhash3.c hash_join.c fnv1a.c -O3 -o query11 -lm
gcc main_query11_parallel.c header.h hash_table.c murmurhash3.c hash_join.c fnv1a.c -O3 -o query11parallel -lm
